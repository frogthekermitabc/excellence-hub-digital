      ...
      <section id="about" className="py-16 bg-muted scroll-mt-32">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">{t("iso14001.description1")}</p>
            <p className="text-lg text-muted-foreground leading-relaxed">{t("iso14001.description2")}</p>
          </div>
        </div>
      </section>
            ...
            <Card className="p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{t("iso14001.benefit1Desc")}</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{t("iso14001.benefit2Desc")}</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{t("iso14001.benefit3Desc")}</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{t("iso14001.benefit4Desc")}</p>
                </div>
              </div>
            </Card>
          </div>
