  ...
  return (
    <div className="min-h-screen">
      ...
      <section id="schedule" className="py-16 scroll-mt-32">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8 text-center">ISO 37001 Course Schedule</h2>
          <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">
            View our upcoming ISO 37001:2016 Anti-Bribery Management System training sessions.
          </p>
          <CourseScheduleTable courseType="ISO 37001" />
        </div>
      </section>
